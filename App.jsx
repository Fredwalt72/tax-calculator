...
const T = {
  en: {
    ...
    disclaimer: "⚠ Federal + provincial/state income tax only, after personal basic amount where available. Social contributions, other credits and deductions not included. Exchange rates are approximate. Consult a tax professional.",
    ...
    compareTaxLabel: "TAX",
    compareBasicLabel: "BASIC AMOUNT",
    compareNetLabel: "NET",
  ...
  fr: {
    ...
    compareBasicLabel: "MONTANT DE BASE",
    compareNetLabel: "NET",
  ...
  es: {
    ...
    compareBasicLabel: "MONTO BÁSICO",
  ...
  ar: {
    ...
    compareBasicLabel: "المبلغ الأساسي",
...
const PROVINCES_CA = [
  { name:"Ontario",                   abbr:"ON", basic:11865, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Flag_of_Ontario.svg/320px-Flag_of_Ontario.svg.png",           brackets:[[0,51446,.0505],[51446,102894,.0915],[102894,150000,.1116],[150000,220000,.1216],[220000,Infinity,.1316]] },
  { name:"Québec",                    abbr:"QC", basic:17183, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Flag_of_Quebec.svg/320px-Flag_of_Quebec.svg.png",            brackets:[[0,51780,.14],[51780,103545,.19],[103545,126000,.24],[126000,Infinity,.2575]] },
  { name:"Colombie-Britannique",      abbr:"BC", basic:11981, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Flag_of_British_Columbia.svg/320px-Flag_of_British_Columbia.svg.png", brackets:[[0,45654,.0506],[45654,91310,.077],[91310,104835,.105],[104835,127299,.1229],[127299,172602,.147],[172602,240716,.168],[240716,Infinity,.205]] },
  { name:"Alberta",                   abbr:"AB", basic:21003, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Flag_of_Alberta.svg/320px-Flag_of_Alberta.svg.png",          brackets:[[0,148269,.10],[148269,177922,.12],[177922,237230,.13],[237230,355845,.14],[355845,Infinity,.15]] },
  { name:"Saskatchewan",              abbr:"SK", basic:17661, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Flag_of_Saskatchewan.svg/320px-Flag_of_Saskatchewan.svg.png", brackets:[[0,49720,.105],[49720,142058,.125],[142058,Infinity,.145]] },
  { name:"Manitoba",                  abbr:"MB", basic:15780, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Flag_of_Manitoba.svg/320px-Flag_of_Manitoba.svg.png",         brackets:[[0,36842,.108],[36842,79625,.1275],[79625,Infinity,.174]] },
  { name:"Nouvelle-Écosse",           abbr:"NS", basic:8481, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Flag_of_Nova_Scotia.svg/320px-Flag_of_Nova_Scotia.svg.png",   brackets:[[0,29590,.0879],[29590,59180,.1495],[59180,93000,.1667],[93000,150000,.175],[150000,Infinity,.21]] },
  { name:"Nouveau-Brunswick",         abbr:"NB", basic:12458, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Flag_of_New_Brunswick.svg/320px-Flag_of_New_Brunswick.svg.png",brackets:[[0,47715,.094],[47715,95431,.1482],[95431,176756,.1652],[176756,Infinity,.195]] },
  { name:"Île-du-Prince-Édouard",     abbr:"PE", basic:12000, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Flag_of_Prince_Edward_Island.svg/320px-Flag_of_Prince_Edward_Island.svg.png", brackets:[[0,32656,.0965],[32656,64313,.1363],[64313,105000,.1665],[105000,140000,.18],[140000,Infinity,.1875]] },
  { name:"Terre-Neuve-et-Labrador",   abbr:"NL", basic:10818, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Flag_of_Newfoundland_and_Labrador.svg/320px-Flag_of_Newfoundland_and_Labrador.svg.png", brackets:[[0,43198,.087],[43198,86395,.145],[86395,154244,.158],[154244,215943,.178],[215943,275870,.198],[275870,551739,.208],[551739,Infinity,.213]] },
  { name:"Territoires du Nord-Ouest", abbr:"NT", basic:16593, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Flag_of_the_Northwest_Territories.svg/320px-Flag_of_the_Northwest_Territories.svg.png", brackets:[[0,50597,.059],[50597,101198,.086],[101198,164525,.122],[164525,Infinity,.1405]] },
  { name:"Yukon",                     abbr:"YT", basic:15705, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Flag_of_Yukon.svg/320px-Flag_of_Yukon.svg.png",              brackets:[[0,57375,.064],[57375,114750,.09],[114750,158519,.109],[158519,500000,.128],[500000,Infinity,.15]] },
  { name:"Nunavut",                   abbr:"NU", basic:17925, flagImg:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Flag_of_Nunavut.svg/320px-Flag_of_Nunavut.svg.png",           brackets:[[0,53268,.04],[53268,106537,.07],[106537,173205,.09],[173205,Infinity,.115]] },
];
...
const STATES_US = [
  { name:"Alabama",        abbr:"AL", basic:3000, flagImg:"https://flagcdn.com/w40/us-al.png",        brackets:[[0,500,.02],[500,3000,.04],[3000,Infinity,.05]] },
  { name:"Alaska",         abbr:"AK", flagImg:"https://flagcdn.com/w40/us-ak.png",         brackets:[[0,Infinity,0]] },
  { name:"Arizona",        abbr:"AZ", basic:14600, flagImg:"https://flagcdn.com/w40/us-az.png",        brackets:[[0,Infinity,.025]] },
  { name:"Arkansas",       abbr:"AR", basic:2200, flagImg:"https://flagcdn.com/w40/us-ar.png",       brackets:[[0,4300,.02],[4300,8500,.04],[8500,Infinity,.044]] },
  { name:"California",     abbr:"CA", basic:5202, flagImg:"https://flagcdn.com/w40/us-ca.png",     brackets:[[0,10099,.01],[10099,23942,.02],[23942,37788,.04],[37788,52455,.06],[52455,66295,.08],[66295,338639,.093],[338639,406364,.103],[406364,677275,.113],[677275,Infinity,.123]] },
  { name:"Colorado",       abbr:"CO", basic:14600, flagImg:"https://flagcdn.com/w40/us-co.png",       brackets:[[0,Infinity,.044]] },
  { name:"Connecticut",    abbr:"CT", basic:15000, flagImg:"https://flagcdn.com/w40/us-ct.png",    brackets:[[0,10000,.03],[10000,50000,.05],[50000,100000,.055],[100000,200000,.06],[200000,250000,.065],[250000,500000,.069],[500000,Infinity,.0699]] },
  { name:"Delaware",       abbr:"DE", basic:3250, flagImg:"https://flagcdn.com/w40/us-de.png",       brackets:[[0,2000,0],[2000,5000,.022],[5000,10000,.039],[10000,20000,.048],[20000,25000,.052],[25000,60000,.0555],[60000,Infinity,.066]] },
  { name:"Florida",        abbr:"FL", flagImg:"https://flagcdn.com/w40/us-fl.png",        brackets:[[0,Infinity,0]] },
  { name:"Georgia",        abbr:"GA", basic:12000, flagImg:"https://flagcdn.com/w40/us-ga.png", brackets:[[0,Infinity,.0549]] },
  { name:"Hawaii",         abbr:"HI", basic:2200, flagImg:"https://flagcdn.com/w40/us-hi.png",         brackets:[[0,2400,.014],[2400,4800,.032],[4800,9600,.055],[9600,14400,.064],[14400,19200,.068],[19200,24000,.072],[24000,36000,.076],[36000,48000,.079],[48000,Infinity,.0825]] },
  { name:"Idaho",          abbr:"ID", basic:14600, flagImg:"https://flagcdn.com/w40/us-id.png",          brackets:[[0,Infinity,.058]] },
  { name:"Illinois",       abbr:"IL", basic:2425, flagImg:"https://flagcdn.com/w40/us-il.png",       brackets:[[0,Infinity,.0495]] },
  { name:"Indiana",        abbr:"IN", basic:1000, flagImg:"https://flagcdn.com/w40/us-in.png",        brackets:[[0,Infinity,.0305]] },
  { name:"Iowa",           abbr:"IA", basic:14600, flagImg:"https://flagcdn.com/w40/us-ia.png",           brackets:[[0,6000,.044],[6000,30000,.0482],[30000,Infinity,.057]] },
  { name:"Kansas",         abbr:"KS", basic:3500, flagImg:"https://flagcdn.com/w40/us-ks.png",         brackets:[[0,15000,.031],[15000,30000,.0525],[30000,Infinity,.057]] },
  { name:"Kentucky",       abbr:"KY", basic:3160, flagImg:"https://flagcdn.com/w40/us-ky.png",       brackets:[[0,Infinity,.04]] },
  { name:"Louisiana",      abbr:"LA", basic:4500, flagImg:"https://flagcdn.com/w40/us-la.png",      brackets:[[0,12500,.0185],[12500,50000,.035],[50000,Infinity,.0425]] },
  { name:"Maine",          abbr:"ME", basic:14600, flagImg:"https://flagcdn.com/w40/us-me.png",          brackets:[[0,24500,.058],[24500,58050,.0675],[58050,Infinity,.0715]] },
  { name:"Maryland",       abbr:"MD", basic:2400, flagImg:"https://flagcdn.com/w40/us-md.png",       brackets:[[0,1000,.02],[1000,2000,.03],[2000,3000,.04],[3000,100000,.0475],[100000,125000,.05],[125000,150000,.0525],[150000,250000,.055],[250000,Infinity,.0575]] },
  { name:"Massachusetts",  abbr:"MA", flagImg:"https://flagcdn.com/w40/us-ma.png",  brackets:[[0,Infinity,.05]] },
  { name:"Michigan",       abbr:"MI", basic:5600, flagImg:"https://flagcdn.com/w40/us-mi.png",       brackets:[[0,Infinity,.0405]] },
  { name:"Minnesota",      abbr:"MN", basic:14575, flagImg:"https://flagcdn.com/w40/us-mn.png",      brackets:[[0,30070,.0535],[30070,98760,.068],[98760,183340,.0785],[183340,Infinity,.0985]] },
  { name:"Mississippi",    abbr:"MS", basic:6000, flagImg:"https://flagcdn.com/w40/us-ms.png",    brackets:[[0,10000,0],[10000,Infinity,.047]] },
  { name:"Missouri",       abbr:"MO", basic:14600, flagImg:"https://flagcdn.com/w40/us-mo.png",       brackets:[[0,1207,0],[1207,Infinity,.048]] },
  { name:"Montana",        abbr:"MT", basic:14600, flagImg:"https://flagcdn.com/w40/us-mt.png",        brackets:[[0,20500,.047],[20500,Infinity,.059]] },
  { name:"Nebraska",       abbr:"NE", basic:7900, flagImg:"https://flagcdn.com/w40/us-ne.png",       brackets:[[0,3700,.0246],[3700,22170,.0351],[22170,35730,.0501],[35730,Infinity,.0584]] },
  ...
  { name:"New Jersey",     abbr:"NJ", basic:1000, flagImg:"https://flagcdn.com/w40/us-nj.png",     brackets:[[0,20000,.014],[20000,35000,.0175],[35000,40000,.035],[40000,75000,.05525],[75000,500000,.0637],[500000,1000000,.0897],[1000000,Infinity,.1075]] },
  { name:"New Mexico",     abbr:"NM", basic:14600, flagImg:"https://flagcdn.com/w40/us-nm.png",     brackets:[[0,5500,.017],[5500,11000,.032],[11000,16000,.047],[16000,210000,.049],[210000,Infinity,.059]] },
  { name:"New York",       abbr:"NY", basic:8000, flagImg:"https://flagcdn.com/w40/us-ny.png",       brackets:[[0,8500,.04],[8500,11700,.045],[11700,13900,.0525],[13900,21400,.0585],[21400,80650,.0625],[80650,215400,.0685],[215400,1077550,.0965],[1077550,5000000,.103],[5000000,Infinity,.109]] },
  { name:"North Carolina", abbr:"NC", basic:12750, flagImg:"https://flagcdn.com/w40/us-nc.png", brackets:[[0,Infinity,.045]] },
  { name:"North Dakota",   abbr:"ND", basic:14600, flagImg:"https://flagcdn.com/w40/us-nd.png",   brackets:[[0,44725,.011],[44725,Infinity,.0204]] },
  ...
  { name:"Oklahoma",       abbr:"OK", basic:6350, flagImg:"https://flagcdn.com/w40/us-ok.png",       brackets:[[0,1000,.0025],[1000,2500,.0075],[2500,3750,.0175],[3750,4900,.0275],[4900,7200,.0375],[7200,Infinity,.0475]] },
  { name:"Oregon",         abbr:"OR", basic:2420, flagImg:"https://flagcdn.com/w40/us-or.png",         brackets:[[0,18400,.0475],[18400,46200,.0675],[46200,250000,.0875],[250000,Infinity,.099]] },
  { name:"Pennsylvania",   abbr:"PA", flagImg:"https://flagcdn.com/w40/us-pa.png",   brackets:[[0,Infinity,.0307]] },
  { name:"Rhode Island",   abbr:"RI", basic:10550, flagImg:"https://flagcdn.com/w40/us-ri.png",   brackets:[[0,77450,.0375],[77450,176050,.0475],[176050,Infinity,.0599]] },
  { name:"South Carolina", abbr:"SC", basic:14600, flagImg:"https://flagcdn.com/w40/us-sc.png", brackets:[[0,3460,0],[3460,17330,.03],[17330,Infinity,.064]] },
  ...
  { name:"Utah",           abbr:"UT", basic:14600, flagImg:"https://flagcdn.com/w40/us-ut.png",           brackets:[[0,Infinity,.0455]] },
  { name:"Vermont",        abbr:"VT", basic:7000, flagImg:"https://flagcdn.com/w40/us-vt.png",        brackets:[[0,45400,.0335],[45400,110050,.066],[110050,229550,.076],[229550,Infinity,.0875]] },
  { name:"Virginia",       abbr:"VA", basic:8500, flagImg:"https://flagcdn.com/w40/us-va.png",       brackets:[[0,3000,.02],[3000,5000,.03],[5000,17000,.05],[17000,Infinity,.0575]] },
  ...
  { name:"Wisconsin",      abbr:"WI", basic:13230, flagImg:"https://flagcdn.com/w40/us-wi.png",      brackets:[[0,13810,.0354],[13810,27630,.0465],[27630,304170,.053],[304170,Infinity,.0765]] },
  { name:"Wyoming",        abbr:"WY", flagImg:"https://flagcdn.com/w40/us-wy.png",        brackets:[[0,Infinity,0]] },
  { name:"Washington D.C.",abbr:"DC", basic:14600, flagImg:"https://flagcdn.com/w40/us-dc.png", brackets:[[0,10000,.04],[10000,40000,.06],[40000,60000,.065],[60000,250000,.085],[250000,500000,.0925],[500000,Infinity,.0975]] },
];

const OTHER_COUNTRIES = [
  { name:"England & Wales",flag:"🇬🇧", basic:12570, localPerUSD:0.79,  brackets:[[0,12570,0],[12570,50270,.20],[50270,125140,.40],[125140,Infinity,.45]] },
  { name:"Scotland",          flag:"🏴", basic:12570, localPerUSD:0.79,  brackets:[[0,12570,0],[12570,14876,.19],[14876,26561,.20],[26561,43662,.21],[43662,75000,.42],[75000,125140,.45],[125140,Infinity,.48]] },
  { name:"France",         flag:"🇫🇷", basic:10777, localPerUSD:0.92,  brackets:[[0,10777,0],[10777,27478,.11],[27478,78570,.30],[78570,168994,.41],[168994,Infinity,.45]] },
  { name:"Germany",        flag:"🇩🇪", basic:11604, localPerUSD:0.92,  brackets:[[0,11784,0],[11784,17005,.14],[17005,66760,.24],[66760,277826,.42],[277826,Infinity,.45]] },
  { name:"Australia",      flag:"🇦🇺", basic:18200, localPerUSD:1.55,  brackets:[[0,18200,0],[18200,45000,.19],[45000,120000,.325],[120000,180000,.37],[180000,Infinity,.45]] },
  { name:"Japan",          flag:"🇯🇵", basic:480000, localPerUSD:149,   brackets:[[0,1950000,.05],[1950000,3300000,.10],[3300000,6950000,.20],[6950000,9000000,.23],[9000000,18000000,.33],[18000000,40000000,.40],[40000000,Infinity,.45]] },
  ...
  { name:"Sweden",         flag:"🇸🇪", basic:24238, localPerUSD:10.42, brackets:[[0,120000,0],[120000,509300,.32],[509300,Infinity,.52]] },
  { name:"Norway",         flag:"🇳🇴", basic:88250, localPerUSD:10.55, brackets:[[0,190350,.22],[190350,267900,.238],[267900,643800,.262],[643800,969200,.358],[969200,Infinity,.388]] },
  ...
  { name:"Spain",          flag:"🇪🇸", basic:5550, localPerUSD:0.92,  brackets:[[0,12450,.19],[12450,20200,.24],[20200,35200,.30],[35200,60000,.37],[60000,300000,.45],[300000,Infinity,.47]] },
  { name:"Italy",          flag:"🇮🇹", basic:8174, localPerUSD:0.92,  brackets:[[0,28000,.23],[28000,50000,.35],[50000,Infinity,.43]] },
  { name:"Portugal",       flag:"🇵🇹", basic:4104, localPerUSD:0.92,  brackets:[[0,7703,.1325],[7703,11623,.18],[11623,16472,.23],[16472,21321,.26],[21321,27146,.3275],[27146,39791,.37],[39791,51997,.435],[51997,81199,.45],[81199,Infinity,.48]] },
  { name:"Ireland",        flag:"🇮🇪", basic:3750, localPerUSD:0.92,  brackets:[[0,42000,.20],[42000,Infinity,.40]] },
  { name:"New Zealand",    flag:"🇳🇿", basic:14000, localPerUSD:1.63,  brackets:[[0,14000,.105],[14000,48000,.175],[48000,70000,.30],[70000,180000,.33],[180000,Infinity,.39]] },
  { name:"South Korea",    flag:"🇰🇷", basic:1500000, localPerUSD:1330,  brackets:[[0,14000000,.06],[14000000,50000000,.15],[50000000,88000000,.24],[88000000,150000000,.35],[150000000,300000000,.38],[300000000,500000000,.40],[500000000,1000000000,.42],[1000000000,Infinity,.45]] },
  { name:"India",          flag:"🇮🇳", basic:300000, localPerUSD:83.5,  brackets:[[0,300000,0],[300000,600000,.05],[600000,900000,.10],[900000,1200000,.15],[1200000,1500000,.20],[1500000,Infinity,.30]] },
  { name:"China",          flag:"🇨🇳", basic:60000, localPerUSD:7.24,  brackets:[[0,36000,.03],[36000,144000,.10],[144000,300000,.20],[300000,420000,.25],[420000,660000,.30],[660000,960000,.35],[960000,Infinity,.45]] },
  { name:"Brazil",         flag:"🇧🇷", basic:28559, localPerUSD:4.97,  brackets:[[0,27110,0],[27110,33919,.075],[33919,45012,.15],[45012,55976,.225],[55976,Infinity,.275]] },
  ...
  { name:"South Africa",   flag:"🇿🇦", basic:95750, localPerUSD:18.6,  brackets:[[0,237100,.18],[237100,370500,.26],[370500,512800,.31],[512800,673000,.36],[673000,857900,.39],[857900,1817000,.41],[1817000,Infinity,.45]] },
  { name:"Russia",         flag:"🇷🇺", localPerUSD:92,    brackets:[[0,5000000,.13],[5000000,Infinity,.15]] },
  { name:"Thailand",       flag:"🇹🇭", basic:60000, localPerUSD:35.2,  brackets:[[0,150000,0],[150000,300000,.05],[300000,500000,.10],[500000,750000,.15],[750000,1000000,.20],[1000000,2000000,.25],[2000000,5000000,.30],[5000000,Infinity,.35]] },
  { name:"Poland",         flag:"🇵🇱", basic:30000, localPerUSD:4.05,  brackets:[[0,120000,.12],[120000,Infinity,.32]] },
  { name:"UAE",            flag:"🇦🇪", localPerUSD:3.67,  brackets:[[0,Infinity,0]] },
  { name:"Saudi Arabia",   flag:"🇸🇦", localPerUSD:3.75,  brackets:[[0,Infinity,0]] },
  { name:"Hong Kong",      flag:"🇭🇰", basic:132000, localPerUSD:7.82,  brackets:[[0,50000,.02],[50000,100000,.06],[100000,150000,.10],[150000,200000,.14],[200000,Infinity,.17]] },
  { name:"Greece",          flag:"🇬🇷", localPerUSD:0.92,  brackets:[[0,10000,0],[10000,20000,.09],[20000,30000,.28],[30000,40000,.36],[40000,Infinity,.44]] },
  { name:"Finland",         flag:"🇫🇮", basic:3500, localPerUSD:5.42,  brackets:[[0,19900,0],[19900,29700,.0641],[29700,49000,.1745],[49000,85800,.2180],[85800,Infinity,.3160]] },
  { name:"Austria",         flag:"🇦🇹", basic:12816, localPerUSD:0.92,  brackets:[[0,11693,0],[11693,19134,.20],[19134,32075,.30],[32075,62080,.41],[62080,93120,.48],[93120,1000000,.50],[1000000,Infinity,.55]] },
  { name:"Belgium",         flag:"🇧🇪", basic:9270, localPerUSD:0.92,  brackets:[[0,15820,0],[15820,27920,.25],[27920,48320,.40],[48320,Infinity,.50]] },
  { name:"Czech Republic",  flag:"🇨🇿", basic:30840, localPerUSD:23.2,  brackets:[[0,1582812,.15],[1582812,Infinity,.23]] },
  { name:"Hungary",         flag:"🇭🇺", localPerUSD:356,   brackets:[[0,Infinity,.15]] },
  { name:"Romania",         flag:"🇷🇴", basic:3600, localPerUSD:4.68,  brackets:[[0,Infinity,.10]] },
  { name:"Israel",          flag:"🇮🇱", basic:18480, localPerUSD:3.70,  brackets:[[0,81480,.10],[81480,116760,.14],[116760,187440,.20],[187440,260520,.31],[260520,542160,.35],[542160,698280,.47],[698280,Infinity,.50]] },
  ...
  { name:"Chile",           flag:"🇨🇱", basic:9360756, localPerUSD:950,   brackets:[[0,8380560,0],[8380560,18657240,.04],[18657240,31095400,.08],[31095400,43533560,.135],[43533560,56221480,.23],[56221480,74962040,.304],[74962040,Infinity,.35]] },
  { name:"Argentina",       flag:"🇦🇷", basic:451683, localPerUSD:900,   brackets:[[0,1030700,0],[1030700,2061400,.05],[2061400,3092100,.09],[3092100,4122800,.12],[4122800,5153500,.15],[5153500,6184200,.19],[6184200,7729250,.23],[7729250,11593875,.27],[11593875,15458500,.31],[15458500,Infinity,.35]] },
  ...
  { name:"Malaysia",        flag:"🇲🇾", basic:9000, localPerUSD:4.72,  brackets:[[0,5000,0],[5000,20000,.01],[20000,35000,.03],[35000,50000,.08],[50000,70000,.13],[70000,100000,.21],[100000,250000,.24],[250000,400000,.245],[400000,600000,.25],[600000,1000000,.26],[1000000,2000000,.28],[2000000,Infinity,.30]] },
  { name:"Philippines",     flag:"🇵🇭", basic:250000, localPerUSD:56.5,  brackets:[[0,250000,0],[250000,400000,.15],[400000,800000,.20],[800000,2000000,.25],[2000000,8000000,.30],[8000000,Infinity,.35]] },
  { name:"Indonesia",       flag:"🇮🇩", basic:54000000, localPerUSD:15700, brackets:[[0,60000000,.05],[60000000,250000000,.15],[250000000,500000000,.25],[500000000,5000000000,.30],[5000000000,Infinity,.35]] },
  { name:"Vietnam",         flag:"🇻🇳", basic:11000000, localPerUSD:25000, brackets:[[0,60000000,.05],[60000000,120000000,.10],[120000000,216000000,.15],[216000000,384000000,.20],[384000000,624000000,.25],[624000000,960000000,.30],[960000000,Infinity,.35]] },
  { name:"Egypt",           flag:"🇪🇬", basic:30000, localPerUSD:48.5,  brackets:[[0,30000,0],[30000,45000,.10],[45000,60000,.15],[60000,200000,.20],[200000,400000,.225],[400000,Infinity,.25]] },
  { name:"Nigeria",         flag:"🇳🇬", basic:200000, localPerUSD:1580,  brackets:[[0,300000,.07],[300000,600000,.11],[600000,1100000,.15],[1100000,1600000,.19],[1600000,3200000,.21],[3200000,Infinity,.24]] },
  { name:"Kenya",           flag:"🇰🇪", basic:288000, localPerUSD:130,   brackets:[[0,288000,.10],[288000,388000,.25],[388000,6000000,.30],[6000000,Infinity,.35]] },
  // ── New countries ──────────────────────────────────────────────────────
  { name:"Luxembourg",      flag:"🇱🇺", basic:15960, localPerUSD:0.92,  brackets:[[0,11265,0],[11265,13173,.08],[13173,15681,.09],[15681,18189,.10],[18189,23208,.11],[23208,27687,.12],[27687,32166,.14],[32166,36645,.16],[36645,41124,.18],[41124,45603,.20],[45603,50073,.22],[50073,54543,.24],[54543,59013,.26],[59013,63483,.28],[63483,67962,.30],[67962,114360,.32],[114360,166920,.34],[166920,Infinity,.42]] },
  { name:"Iceland",         flag:"🇮🇸", basic:2016000, localPerUSD:138,   brackets:[[0,Infinity,.3732]] },
  { name:"Croatia",         flag:"🇭🇷", basic:5728, localPerUSD:7.53,  brackets:[[0,360000,.20],[360000,Infinity,.30]] },
  { name:"Slovenia",        flag:"🇸🇮", basic:7500, localPerUSD:0.92,  brackets:[[0,8755,.16],[8755,25922,.26],[25922,51842,.33],[51842,74188,.39],[74188,Infinity,.45]] },
  { name:"Slovakia",        flag:"🇸🇰", basic:5646, localPerUSD:0.92,  brackets:[[0,38553,.19],[38553,Infinity,.25]] },
  { name:"Estonia",         flag:"🇪🇪", basic:7848, localPerUSD:0.92,  brackets:[[0,Infinity,.20]] },
  { name:"Latvia",          flag:"🇱🇻", basic:3600, localPerUSD:0.92,  brackets:[[0,20004,.20],[20004,78100,.23],[78100,Infinity,.31]] },
  { name:"Lithuania",       flag:"🇱🇹", basic:6840, localPerUSD:0.92,  brackets:[[0,101094,.20],[101094,Infinity,.32]] },
  ...
  { name:"Morocco",         flag:"🇲🇦", basic:30000, localPerUSD:10.1,  brackets:[[0,30000,0],[30000,50000,.10],[50000,60000,.20],[60000,80000,.30],[80000,180000,.34],[180000,Infinity,.38]] },
  ...
  { name:"Pakistan",        flag:"🇵🇰", basic:600000, localPerUSD:279,   brackets:[[0,600000,0],[600000,1200000,.05],[1200000,2400000,.15],[2400000,3600000,.25],[3600000,6000000,.30],[6000000,Infinity,.35]] },
  { name:"Bangladesh",      flag:"🇧🇩", basic:300000, localPerUSD:110,   brackets:[[0,300000,0],[300000,400000,.05],[400000,700000,.10],[700000,1100000,.15],[1100000,1600000,.20],[1600000,Infinity,.25]] },
  { name:"Sri Lanka",       flag:"🇱🇰", basic:1200000, localPerUSD:300,   brackets:[[0,1200000,0],[1200000,2700000,.06],[2700000,4200000,.12],[4200000,5700000,.18],[5700000,7200000,.24],[7200000,Infinity,.36]] },
  { name:"Taiwan",          flag:"🇹🇼", basic:92000, localPerUSD:32.3,  brackets:[[0,540000,.05],[540000,1210000,.12],[1210000,2420000,.20],[2420000,4530000,.30],[4530000,10310000,.40],[10310000,Infinity,.45]] },
  { name:"Peru",            flag:"🇵🇪", basic:25750, localPerUSD:3.73,  brackets:[[0,25750,.08],[25750,120050,.14],[120050,Infinity,.30]] },
  { name:"Ecuador",         flag:"🇪🇨", basic:11902, localPerUSD:1,     brackets:[[0,11902,0],[11902,15159,.05],[15159,19682,.10],[19682,26031,.12],[26031,34255,.15],[34255,45407,.20],[45407,60450,.25],[60450,80600,.30],[80600,Infinity,.35]] },
  { name:"Uruguay",         flag:"🇺🇾", basic:43117, localPerUSD:39.5,  brackets:[[0,43117,0],[43117,61595,.10],[61595,92393,.15],[92393,184787,.24],[184787,277181,.25],[277181,369574,.27],[369574,Infinity,.31]] },
  { name:"Panama",          flag:"🇵🇦", basic:11000, localPerUSD:1,     brackets:[[0,11000,0],[11000,50000,.15],[50000,Infinity,.25]] },
  { name:"Costa Rica",      flag:"🇨🇷", basic:929000, localPerUSD:520,   brackets:[[0,929000,0],[929000,1362000,.10],[1362000,2271000,.15],[2271000,4543000,.20],[4543000,Infinity,.25]] },
  { name:"Ghana",           flag:"🇬🇭", basic:402, localPerUSD:14.7,  brackets:[[0,402,0],[402,510,.05],[510,660,.10],[660,3240,.175],[3240,19980,.25],[19980,Infinity,.30]] },
  ...
  { name:"Andorra",         flag:"🇦🇩", basic:24000, localPerUSD:0.92,  brackets:[[0,24000,0],[24000,40000,.05],[40000,Infinity,.10]] },
  ...
  { name:"Azerbaijan",      flag:"🇦🇿", basic:2500, localPerUSD:1.70,  brackets:[[0,2500,.14],[2500,Infinity,.25]] },
...
function calcEntry(salaryUSD, localPerUSD, fedBrackets, provBrackets, fedBasic=0, provBasic=0) {
  const local        = salaryUSD * localPerUSD;
  const fedTaxable   = Math.max(0, local - fedBasic);
  const provTaxable  = Math.max(0, local - provBasic);
  const fedLocal     = applyBrackets(fedTaxable, fedBrackets);
  const provLocal    = provBrackets ? applyBrackets(provTaxable, provBrackets) : 0;
  ...
  const basicUSD = (fedBasic + provBasic) / localPerUSD;
  return { taxUSD, provTaxUSD, totalTaxUSD, netUSD, effectiveRate:eff, fedRate:fed, provRate:prov, basicUSD, fedBasic, provBasic };
}
...
function CompareModal({ items, onRemove, onClose, onReset, fmt, t, lang, sortedList }) {
  ...
  const rows = [
    ...
    { label: t.compareBasicLabel||"MONTANT DE BASE", color:"#5588bb", fn: c => c.basicUSD > 0 ? fmt(c.basicUSD) : "—", small: true },
...
function ContactSection({ t }) {
  ...
  async function handleSubmit(e) {
    ...
    setStatus("sending");
    try {
      const res = await fetch("https://formspree.io/f/mojywzkv", {
        method: "POST",
...
export default function App() {
  ...
  const provCalcs = useMemo(() => {
    if (!salaryUSD) return {};
    return Object.fromEntries(PROVINCES_CA.map(p => [p.name, calcEntry(salaryUSD, CA_USD, CA_FEDERAL, p.brackets, 16782, p.basic||0)]));
  }, [salaryUSD]);

  const stateCalcs = useMemo(() => {
    if (!salaryUSD) return {};
    return Object.fromEntries(STATES_US.map(s => [s.name, calcEntry(salaryUSD, 1, US_FEDERAL, s.brackets, 14600, s.basic||0)]));
  }, [salaryUSD]);

  const countryCalcs = useMemo(() => {
    if (!salaryUSD) return {};
    return Object.fromEntries(OTHER_COUNTRIES.map(c => [c.name, calcEntry(salaryUSD, c.localPerUSD, c.brackets, null, c.basic||0, 0)]));
  }, [salaryUSD]);
